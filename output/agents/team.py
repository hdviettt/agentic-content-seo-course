...
team = Team(
    ...
    members=[content_creator, status_tracker, seo_manager],
    instructions=[
        ...
        "  4. Track SERP rankings and set published URLs",
        ...
        "- SEO Manager: setting published URLs, checking SERP rankings",
