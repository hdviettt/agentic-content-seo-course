...
team = Team(
    ...
    instructions=[
        ...
        "CRITICAL: NEVER send a preliminary message like 'Let me analyze...' or 'I'll look into...' before delegating.",
        "Delegate IMMEDIATELY, wait for the member's complete response, then relay it.",
